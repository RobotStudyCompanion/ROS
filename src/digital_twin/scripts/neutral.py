...
class Neutral(Node):
    def __init__(self):
        ...
        self.max_positions1 = [3.0, 3.0]  # Adjust these values based on your robot's limits
        self.min_positions1 = [0.0, 0.0]  # Lower positions for "shaking"
        self.max_positions2 = [0.5, -0.5]  # Adjust these values based on your robot's limits
    ...
    def move_arms_to_top(self):
        print('Gradually move arms to the top position')
    ...
    def shake_arms_top(self):
        print("going up")
        print(self.joint_state.position[0] , -self.max_positions2[0])
    ...
    def shake_arms_down(self):
        print("going down")
        print(self.joint_state.position[0] , self.min_positions2[0])
